...
public class Patient {
    ...
    public Patient(String id, String name, int age, String bloodType, String organNeeded, int urgencyLevel,
        ...
        if (urgencyLevel < 1 || urgencyLevel > 10) throw new IllegalArgumentException("Urgency level must be between 1 and 10.");
        if (!status.equals("WAITING")) throw new IllegalArgumentException("New patients must have status 'WAITING'.");
