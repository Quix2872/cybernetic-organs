...
public class CyberneticOrgan {
    ...
    public CyberneticOrgan(String id, String type, String model, int powerLevel, double compatibilityScore,
        ...
        if (powerLevel < 1 || powerLevel > 100) throw new IllegalArgumentException("Power level must be between 1 and 100.");
        if (compatibilityScore < 0.0 || compatibilityScore > 1.0) throw new IllegalArgumentException("Compatibility score must be between 0.0 and 1.0.");
